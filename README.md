...
After LoRA fine-tuning completes, the corresponding LoRA weights will be generated. Use the `Export` function in the UI to merge these weights into the base model. We name the merged model `lora-qkvo-model` and store it under the `Qwen` folder.
